...
typedef enum {
    ...
    /** Do not @em overallocate a requested free space to reduce fragmentation  */
...
typedef struct IWFS_FSM {
    ...
    /* See iwrwlfile.h */
    iwrc(*lock)(struct IWFS_FSM* f, off_t start, off_t len, iwrl_lockflags lflags);
    iwrc(*try_lock)(struct IWFS_FSM* f, off_t start, off_t len, iwrl_lockflags lflags);
    iwrc(*unlock)(struct IWFS_FSM* f, off_t start, off_t len);
    iwrc(*lwrite)(struct IWFS_FSM* f, off_t start, const void *buf, size_t siz, size_t *sp);
    iwrc(*lread)(struct IWFS_FSM* f, off_t start, void *buf, size_t siz, size_t *sp);
